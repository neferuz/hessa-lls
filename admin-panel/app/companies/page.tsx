                    ...
                    <DashboardHeader
                        title={
                            <div className="flex items-center gap-2">
                                ...
                                <h1 className="text-base font-bold tracking-tight">Страница "Компании"</h1>
                            </div>
                        }
                        description="Управление контентом страницы для корпоративных клиентов"
                        actions={
