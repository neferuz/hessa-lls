    ...
    usePageHeader({
        title: (
            <div className="flex items-center gap-2">
                ...
                <h1 className="text-base font-bold tracking-tight text-[family-name:var(--font-unbounded)] uppercase">О компании</h1>
            </div>
        ),
    ...
    return (
        <>
            <div className="w-full overflow-y-auto overflow-x-hidden p-0 h-full bg-muted/30 scrollbar-none">
                <StaticPageForm lang={lang} pageKey="about_page" title="О компании" />
            </div>
        </>
    );
}
