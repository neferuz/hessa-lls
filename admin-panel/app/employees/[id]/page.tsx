...
export default function EmployeeDetailsPage() {
        ...
        title: (
            <div className="flex items-center gap-2">
                ...
                <h1 className="text-base font-bold tracking-tight text-[family-name:var(--font-unbounded)] uppercase">
                    {employee ? employee.full_name || employee.username : "Карточка сотрудника"}
                </h1>
            </div>
        ),
        description: employee ? `Просмотр и редактирование данных сотрудника ${employee.username}` : "Загрузка данных сотрудника..."
    });
    ...
    const handlePaySalary = async () => {
        ...
        try {
            const res = await fetch(`${API_BASE_URL}/api/employees/${employee.id}/pay`, {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({
                    amount: salaryAmount,
            ...
            <div className="flex-1 w-full overflow-y-auto">
                {loading ? (
                    ...
                    <div className="min-h-full bg-background/50 pb-8">
                        ...
                        <div className="h-32 md:h-40 bg-gradient-to-r from-neutral-100 to-neutral-50 dark:from-neutral-900/50 dark:to-neutral-950/50 border-b border-border/50 relative overflow-hidden w-full text-left">
                        ...
                        <div className="w-full px-6 relative -mt-12 space-y-6 text-left">
                                    ...
                                    >
                                        <Card className="h-full rounded-2xl border-border/60 bg-card shadow-none overflow-hidden flex flex-col">
                                            <div className="p-5 pb-3 border-b border-border/40 flex items-center justify-between bg-muted/10">
                                                ...
                                                <div className="bg-background border px-2 py-1 rounded-lg text-[10px] font-medium text-muted-foreground shadow-none tabular-nums">
                                                                ...
                                                                <div className="flex items-center gap-3">
                                                                    <div className="size-10 rounded-xl bg-emerald-500/10 flex items-center justify-center shrink-0 text-emerald-600 group-hover:scale-105 transition-transform duration-300">
                                                                        <div className="size-full text-center leading-none flex flex-col items-center justify-center">
                                                                            ...
                                                                            <span className="text-sm font-semibold tabular-nums">{format(new Date(payment.payment_date), "dd")}</span>
                                                                        </div>
                                                                    </div>
