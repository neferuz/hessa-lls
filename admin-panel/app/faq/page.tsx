            ...
            <div className="h-svh overflow-hidden lg:p-2 w-full">
                <div className="lg:border lg:rounded-md overflow-hidden flex flex-col items-center justify-start bg-container h-full w-full bg-background relative border-border/40">
                    <DashboardHeader
                        title={
                            <div className="flex items-center gap-2">
                                ...
                                <h1 className="text-base font-bold tracking-tight">Редактор FAQ</h1>
                            </div>
                        }
                        description="Управление списком часто задаваемых вопросов и ответов"
                        actions={
                    ...
                    <div className="w-full overflow-y-auto overflow-x-hidden p-0 h-full bg-muted/30">
                        <StaticPageForm lang={lang} pageKey="faq_page" title="Часто задаваемые вопросы" />
                    </div>
                </div>
            </div>
        </SidebarProvider>
