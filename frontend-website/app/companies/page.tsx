                        ...
                        <SwiperSlide>
                            <div className={styles.productCard}>
                                ...
                                <div className={styles.productContent} style={{ textAlign: "left" }}>
                                    <span className={styles.stepNumber}>(01)</span>
                                    <h3 className={styles.productName} style={{ marginTop: "0.5rem" }}>{process1Title}</h3>
                                    <p className={styles.benefitText} style={{ fontSize: "0.8rem" }}>{process1Text}</p>
                                </div>
                            </div>
                        </SwiperSlide>
                        <SwiperSlide>
                            <div className={styles.productCard}>
                                ...
                                <div className={styles.productContent} style={{ textAlign: "left" }}>
                                    <span className={styles.stepNumber}>(02)</span>
                                    <h3 className={styles.productName} style={{ marginTop: "0.5rem" }}>{process2Title}</h3>
                                    <p className={styles.benefitText} style={{ fontSize: "0.8rem" }}>{process2Text}</p>
                                </div>
                            </div>
                        </SwiperSlide>
                        <SwiperSlide>
                            <div className={styles.productCard}>
                                ...
                                <div className={styles.productContent} style={{ textAlign: "left" }}>
                                    <span className={styles.stepNumber}>(03)</span>
                                    <h3 className={styles.productName} style={{ marginTop: "0.5rem" }}>{process3Title}</h3>
                                    <p className={styles.benefitText} style={{ fontSize: "0.8rem" }}>{process3Text}</p>
                                </div>
                            </div>
                        </SwiperSlide>
                    </Swiper>
