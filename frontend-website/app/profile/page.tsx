                            ...
                            <div className={styles.overviewSection}>
                                ...
                                <div className={styles.overviewGrid}>
                                    ...
                                    >
                                        ...
                                        <div className={styles.cardContent}>
                                            <p style={{ fontSize: '0.9rem', color: '#666', lineHeight: 1.5, marginBottom: '0.5rem', fontFamily: 'var(--font-manrope), sans-serif' }}>
                                                {t.referral.desc}
                                            </p>

                                            <div style={{ background: '#f8fafc', padding: '1rem', borderRadius: '16px', border: '1px solid #edf2f7', marginTop: '0.5rem' }}>
                                                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.35rem' }}>
                                                    <span style={{ fontSize: '0.7rem', color: '#94a3b8', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.05em', fontFamily: 'var(--font-manrope), sans-serif' }}>{t.referral.yourLink}</span>
                                                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                                                        <span style={{ fontSize: '0.9rem', fontWeight: 600, color: '#334155', fontFamily: 'var(--font-manrope), sans-serif', letterSpacing: '0.02em' }}>hessa.uz/ref/{referralCode}</span>
                                                        <button
                                                            onClick={handleCopy}
                                                            className={styles.editIconBtn}
                                    ...
                                    {/* HESSA Bot Custom Banner Style Card */}
                                    <motion.div
                                        initial={{ opacity: 0, y: 20 }}
                                        animate={{ opacity: 1, y: 0 }}
                                    ...
                                    >
                                        <div style={{ flex: 1, textAlign: 'left' }}>
                                            <div style={{ 
                                                ...
                                                {t.support.bot}
                                                <div style={{ width: '30px', height: '1px', background: '#C497A0' }}></div>
                                            </div>
                                        ...
                                        <div className={styles.desktopOnly} style={{ flexShrink: 0 }}>
                                            <div style={{ 
                                                ...
                                                <span style={{ fontSize: '0.7rem', fontWeight: 700, color: '#94a3b8', textTransform: 'uppercase', letterSpacing: '0.05em' }}>@hessa_uz</span>
                                            </div>
                                        </div>
                                    </motion.div>
                                </div>
